# Boojy Audio — UI Review

**Version:** Draft
**Date:** March 2026
**Status:** Work in progress — filling in section by section
...
## 5. Editors (Bottom Panel)

The bottom panel switches between different editors depending on context. Each editor is a tab.
